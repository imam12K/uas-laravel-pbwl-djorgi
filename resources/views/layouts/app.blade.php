        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/Apotek.png')}}" alt="" width="30" height="30">
                    TOKOH HANDPHONE
                </a>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <ul class="nav nav-underline">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/jenisheadphone') }}">Data Jenis Handphone</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/headphone') }}">Data Handphone</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    onclick="event.preventDefault();
                                     ...
                                     <img src="{{ asset('img/Shutdown_1.png')}}" alt="" width="30" height="24">
